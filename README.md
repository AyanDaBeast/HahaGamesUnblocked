THIS FILE DOES NOT WORK UNLESS YOU DOWNLOAD THE ZIP FILE
INSTRUCTIONS:
1. at the top of your screen there will be a button that says code.
2. click it and at the bottom of the pop up screen press dowload zip
3. now what i want you to do is right click on the zip folder and click extract all or extract zip
4. once done extracting click on the folder and click the HahaGames html file
5. Have fun gaming
